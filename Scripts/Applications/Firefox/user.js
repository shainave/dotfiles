...
// PREF: enforce DNS-over-HTTPS (DoH) and set provider
user_pref("network.trr.mode", 3);
// user_pref("network.trr.uri", "https://dns.dnswarden.com/00000000000000000000048"); // Hagezi Light + TIF
user_pref("network.trr.uri", "https://dns.nextdns.io/2d795e/FireFox"); // NextDNS profile
...
// PREF: Desktop notifications 2=Ask, 1=Allow, 0=Disable
user_pref("permissions.default.desktop-notification", 2);

// PREF: ask whether to open or save new file types
// user_pref("browser.download.always_ask_before_handling_new_types", false);  ===========> Default as of 18/04/2025

// PREF: open-in-new-tab behavior for Bookmarks - in the background
user_pref("browser.tabs.loadBookmarksInBackground", true);

// PREF: Restore pinned tabs without reloading them on startup
// user_pref("browser.sessionstore.restore_pinned_tabs_on_demand", false);

// PREF: New tab page - hide Top Sites shortcuts and set numbers of rows
